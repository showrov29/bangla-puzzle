  ...
  return (
    <div>
      ...
      <div className='container mt-20 mb-20 w-2/3 pl-16 lg:pl-32 text-sm'>
        ...
        <a className='text-sky-500 underline ' href='mailto:contact@deshcareer.com'>contact@deshcareer.com</a>
        ...
        <div>
        <h1 className='font-bold mt-12'>Types of Data Collected</h1>
        <br />
        <br />
        <h1> Personal Data</h1>
        <br />
        ...
        <h1 className='mt-12'>Tracking & Cookies Data</h1>
        <div className='mt-6'>
        ...
        <h1 className='mt-6'>Transfer Of Data</h1>
        <div className='mt-6'>
        ...
        <ul className='mt-6 list-disc'>
            ...
            <li>
            To protect and defend the rights or property of <a href='https://deshcareer.com/privacy/www.banglapuzzle.com'>Bangla Puzzle</a>
            </li>
            <li>
        ...
        <div className='mt-6'>
        If you have any questions about this Privacy Policy, please contact us: contact.deshcareer@gmail.com
        </div>
